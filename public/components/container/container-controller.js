class containerController{
    constructor($state, playerRsp, competitionRsp, gamesRsp, socketService, competitionService,$rootScope,localStorageService,$location) {
...
containerController.$inject = ['$state', 'playerRsp', 'competitionRsp', 'gamesRsp', 'socketService', 'competitionService','$rootScope','localStorageService','$location'];
